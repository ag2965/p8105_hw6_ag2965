...
```{r}
bwt_fit = birthweight_df %>% lm (bwt~blength+gaweeks, data=.)
...
```{r}
bwt_fit2 = birthweight_df %>% lm (bwt~ bhead + blength + babysex + bhead*blength + bhead*babysex + blength*babysex + bhead*blength*babysex, data=.)
